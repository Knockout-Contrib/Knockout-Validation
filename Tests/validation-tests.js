...
test('Object is Valid with a step of 0.1 and isValid returns True', function () {
    var testObj = ko.observable('')
                    .extend({ step: 0.1 });
...
test('Object is Valid with a step of 0.1 and incremented by 0.1 and isValid returns True', function () {
...
test('Object is NOT Valid with a step of 0.1 and isValid returns False', function () {
    var testObj = ko.observable('')
                    .extend({ step: 0.1 });
